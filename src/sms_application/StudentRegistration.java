...
public class StudentRegistration extends BasicFrame {
    ...
    public void addMainSection() {
        ...
        JTextField main_heading = new JTextField("STUDENT REGISTRATION");
        ...
        JLabel studroll = new JLabel("Student ID NO: ");
