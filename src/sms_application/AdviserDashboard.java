...
public class AdviserDashboard extends BasicFrame {
    ...
    public void addMainSection() {
        ...
        JTextField main_heading = new JTextField("Adviser Dashboard");
        ...
        JButton create_btn = new JButton("Student Registration");
