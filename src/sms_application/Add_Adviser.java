...
public class Add_Adviser extends BasicFrame {
    ...
    public void addMainSection() {
        ...
        JTextField main_heading = new JTextField("ADD ADVISER");
        ...
        JLabel username = new JLabel("Adviser ID: ");
        ...
        JButton main_button = new JButton("Add Adviser");
        ...
        main_button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (ad_id.length() >= 5 && pw.length() >= 5 && ad_id.length() <= 20 && pw.length() <= 20) {
                    if (databases.AdviserOperations.addAdviser(ad_id, pw)) {
