...
public class Login extends BasicFrame {
    ...
    public void addMainSection() {
        ...
        JTextField main_heading = new JTextField("WELCOME TO LOGIN");
        ...
        JRadioButton r1 = new JRadioButton("Adviser", true);	//this button is selected by default
        ...
        main_button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (un.length() >= 3 && pw.length() >= 5 && un.length() <= 20 && pw.length() <= 20) {
                    if (r1.isSelected()) //User Login
                    {
                        ...
                        if (databases.ValidateLogin.authenticateUser(un, pw)) {
                            ...
                            JOptionPane.showMessageDialog(null, "Invalid ID/Password" + un + "\nLogin error" + pw);
